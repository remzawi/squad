...
class BiDAFChar2(nn.Module):
    ...
    Args:
        ...
        drop_prob (float): Dropout probability.
    """
    def __init__(self, word_vectors, char_vec, word_len, hidden_size, emb_size = 500, drop_prob=0.):
    ...
    def forward(self, cw_idxs, cc_idxs, qw_idxs, qc_idxs):
        ...
        c_emb = self.resize(self.emb(cw_idxs, cc_idxs))         # (batch_size, c_len, hidden_size)
        q_emb = self.resize(self.emb(qw_idxs, qc_idxs))         # (batch_size, q_len, hidden_size)
