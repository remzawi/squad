...
print('Proportion of no answers in BiDAF: ', (tot - nonzeros)/tot)
_, nonzeros, tot = compute_len(QANet)
print('Proportion of no answers in QANet: ', (tot - nonzeros)/tot)
_, nonzeros, tot = compute_len(ensemble)
print('Proportion of no answers in ensemble: ', (tot - nonzeros)/tot)